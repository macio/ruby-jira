...
module Jira
  class Client
    ...
    module Issues
      ...
      #
      # @url https://developer.atlassian.com/cloud/jira/platform/rest/v3/api-group-issues/#api-rest-api-3-issue-issueidorkey-comment-get
      #
      # @param issue_id_or_key [Integer, String] The ID or key of an issue
      # @param options [Hash] Query parameters
      # @return [Hash]
      ...
      #
      # @url https://developer.atlassian.com/cloud/jira/platform/rest/v3/api-group-issues/#api-rest-api-3-issue-issueidorkey-comment-post
      #
      # @param issue_id_or_key [Integer, String] The ID or key of an issue
      ...
      #
      # @url https://developer.atlassian.com/cloud/jira/platform/rest/v3/api-group-issues/#api-rest-api-3-issue-issueidorkey-comment-id-get
      #
      # @param issue_id_or_key [Integer, String] The ID or key of an issue
      ...
      #
      # @url https://developer.atlassian.com/cloud/jira/platform/rest/v3/api-group-issues/#api-rest-api-3-issue-issueidorkey-comment-id-put
      #
      # @param issue_id_or_key [Integer, String] The ID or key of an issue
      # @param comment_id [Integer, String] The ID of the comment
      # @param payload [Hash] Comment payload
      ...
      #
      # @url https://developer.atlassian.com/cloud/jira/platform/rest/v3/api-group-issues/#api-rest-api-3-issue-issueidorkey-comment-id-delete
      #
      # @param issue_id_or_key [Integer, String] The ID or key of an issue
      # @param comment_id [Integer, String] The ID of the comment
      # @return [nil]
